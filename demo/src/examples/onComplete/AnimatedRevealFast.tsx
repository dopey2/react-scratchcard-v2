    ...
    <Example
      ...
      controls={
        <>
          ...
          <button onClick={() => ref.current?.revealAll({ duration: 1000, blockSize: 4 })}>Reveal All</button>
        </>
      }
    >
      <ScratchCard
        ...
        width={320}
        height={226}
        cover={Covers.color('#0284c7')}
        finishPercent={70}
        onComplete={() => { setComplete(true); ref.current?.revealAll({ duration: 1000, blockSize: 4 }); }}
      >
        <Result />
      </ScratchCard>
    </Example>
